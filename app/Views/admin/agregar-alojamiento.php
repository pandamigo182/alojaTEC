<?php
/**
 * Vista: Formulario para Agregar Alojamiento (Admin)
 */
    ...
    <form method="POST" action="<?= BASE_URL ?>/admin/procesar-agregar">
            ...
            <div class="form-group">
                ...
                <input type="url" 
                       ...
                       value="<?= htmlspecialchars($_SESSION['old_input']['image_path'] ?? '') ?>">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                <div class="form-group">
                    ...
                    <input type="number" 
                           ...
                           step="0.01"
                           placeholder="85.00"
                           value="<?= htmlspecialchars($_SESSION['old_input']['price_per_night'] ?? '') ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" 
                           ...
                           step="0.1"
                           placeholder="4.5"
                           value="<?= htmlspecialchars($_SESSION['old_input']['rating'] ?? '') ?>">
                </div>
            </div>
